...
const app= express();
app.get('/',(req,res) => {
    res.send("Hello from Express server but nothing is here");
});
app.get('/main',(req,res) => {
    res.send("Its a fake main page nothing is going on here" );
});
app.get('/about',(req,res) => {
    res.send("There is no about regarding about me in this page" );
}); 
app.get('/contact',(req,res) => {
    res.send("Don't contact me" );
});
app.get('/info',(req,res) => {
    res.send("if you want any information go to Google" ); 
});
app.listen(9000, () => {
    console.log(`Server is running at port ${9000}`);
});